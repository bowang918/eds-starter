Ext.define('App.view.Viewport', {
	...
	requires: [ 'Ext.ux.TabReorderer', 'Ext.ux.TabCloseMenu', 'App.view.Header', 'App.view.SideBar', 'App.store.Navigation' ],
	...
	initComponent: function() {
		...
		me.items = [ Ext.create('App.view.Header', {
			region: 'north',
			split: false
		}), {
			region: 'center',
