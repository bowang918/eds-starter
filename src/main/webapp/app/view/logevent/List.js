Ext.define('App.view.logevent.List', {
	extend: 'Ext.grid.Panel',
	controller: 'App.controller.LogEvent',

	title: i18n.logevents,
	closable: true,
	border: true,
	requires: [ 'Ext.grid.plugin.RowExpander', 'App.ux.form.field.ClearCombo', 'App.store.LogLevels', 'App.store.LogEvents' ],
	...
	initComponent: function() {
		...
		me.store = Ext.create('App.store.LogEvents');
		...
		me.dockedItems = [ {
			...
			items: [ {
				...
				name: 'logLevelFilter',
				store: Ext.create('App.store.LogLevels'),
				valueField: 'level',
				displayField: 'level',
				queryMode: 'local',
				forceSelection: true
