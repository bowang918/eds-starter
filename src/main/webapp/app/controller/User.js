Ext.define('App.controller.User', {
	extend: 'App.controller.CrudBase',
	...
	destroyFailureCallback: function() {
		App.ux.window.Notification.error(i18n.error, i18n.user_lastAdminUserError);
	},

	formClass: 'App.view.user.Form',

	createModel: function() {
		return Ext.create('App.model.User');
	},
