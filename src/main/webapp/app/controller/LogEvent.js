Ext.define('App.controller.LogEvent', {
	...
	deleteAll: function() {
		...
		logEventService.deleteAll(filter && filter.value, function() {
			App.ux.window.Notification.info(i18n.successful, i18n.logevents_deleted);
			this.doGridRefresh();
		}, this);
	},
	...
	addTestData: function() {
		logEventService.addTestData(function() {
			App.ux.window.Notification.info(i18n.successful, i18n.logevents_testinserted);
			this.doGridRefresh();
		}, this);
