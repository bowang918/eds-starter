...
Ext.define('App.App', {
	...
	requires: [ 'overrides.AbstractMixedCollection', 'App.ux.window.Notification', 'App.view.Viewport', 'App.store.Roles' ],
	...
	init: function() {
		...
		Ext.direct.Manager.on('exception', function(e) {
			if (e.message === 'accessdenied') {
				App.ux.window.Notification.error(i18n.error, i18n.error_accessdenied);
			} else {
				App.ux.window.Notification.error(i18n.error, e.message);
			}
		});
