	...
	public NavigationService() {
		...
		businessNode
				.addChild(new MenuNode(
						...
						"App.view.poll.PollChart", Role.USER, Role.ADMIN));
		...
		administrationNode
				.addChild(new MenuNode(
						...
						"App.view.user.Container", Role.ADMIN));
		...
		systemNode
				.addChild(new MenuNode(
						...
						"App.view.accesslog.TabPanel", Role.ADMIN));
		systemNode
				.addChild(new MenuNode(
						"logevents",
						"data:image/png;base64,",
						"App.view.logevent.List", Role.ADMIN));
		systemNode
				.addChild(new MenuNode(
						"config",
						...
						"App.view.config.Edit", Role.ADMIN));
